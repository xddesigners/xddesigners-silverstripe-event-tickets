<table class="tickets-table" border="0">
    <thead class="tickets-table__header">
        <tr class="tickets-table__header-row">
            <th class="tickets-table__header-col"><%t XD\EventTickets\Fields\TicketsField.TICKETS 'Tickets' %></th>
            <th class="tickets-table__header-col"><%t XD\EventTickets\Fields\TicketsField.PRICE 'Price' %></th>
            <th class="tickets-table__header-col"><%t XD\EventTickets\Fields\TicketsField.AMOUNT 'Amount' %></th>
        </tr>
    </thead>
