<table class="summary-table" border="0">
    ...
    <tr>
        <th class="summary-table__header-col summary-table__header-col--ticket"><%t XD\EventTickets\Fields\SummaryField.Ticket 'Ticket' %></th>
        <th class="summary-table__header-col summary-table__header-col--amount"><%t XD\EventTickets\Fields\SummaryField.Amount 'Amount' %></th>
        <th class="summary-table__header-col summary-table__header-col--price"><%t XD\EventTickets\Fields\SummaryField.Price 'Price' %></th>
    </tr>
    </thead>
    ...
    <tfoot class="summary-table__footer">
        <tr class="summary-table__footer-row summary-table__footer-row--sub-total">
            <td class="summary-table__footer-col summary-table__footer-col--total-label"><%t XD\EventTickets\Fields\SummaryField.Subtotal 'Subtotal' %></td>
        ...
        <tr class="summary-table__footer-row summary-table__footer-row--total">
            <td class="summary-table__footer-col summary-table__footer-col--total-label"><%t XD\EventTickets\Fields\SummaryField.Total 'Total' %></td>
            <td class="summary-table__footer-col summary-table__footer-col--spacer">&nbsp;</td>
