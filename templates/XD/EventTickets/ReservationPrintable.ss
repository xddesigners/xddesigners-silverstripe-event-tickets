            ...
            <tr>
                ...
                <td style="border: 1px solid black; border-left: 0;">
                    <table class="attendee__data">
                        <tr>
                            <td><%t XD\EventTickets\Model\Reservation.Event 'Event' %></td>
                            <td>$TicketPage.EventTitle</td>
                        </tr>
                        <tr>
                            <td><%t XD\EventTickets\Model\Reservation.Address 'Address' %></td>
                            <td>$TicketPage.EventAddress</td>
                        </tr>
                        <tr>
                            <td><%t XD\EventTickets\Model\Reservation.Date 'Date' %></td>
                            <td>$TicketPage.EventStartDate.Nice</td>
                        </tr>
                        <tr>
                            <td><%t XD\EventTickets\Model\Reservation.Ticket 'Ticket' %></td>
                            <td>$Ticket.Title</td>
                        </tr>
                        <tr>
                            <td><%t XD\EventTickets\Model\Reservation.Price 'Price' %></td>
