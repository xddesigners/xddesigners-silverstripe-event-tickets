...
<head>
    ...
    <title><%t XD\EventTickets\Model\Reservation.ReservationSubject 'Your tickets for {event}' event=$TicketPage.EventTitle %></title>
    <style type="text/css">
        * {
...
<body itemscope itemtype="http://schema.org/EmailMessage">
    ...
    <table class="order-content" width="100%" valign="baseline">
        <tr valign="baseline">
            ...
            <th class="align-left" valign="baseline" align="left"><%t XD\EventTickets\Fields\SummaryField.Amount 'Amount' %></th>
        ...
        <% end_if %>
        <tr valign="baseline" class="divider">
            <td class="align-left" valign="baseline" align="left"><strong><%t XD\EventTickets\Fields\SummaryField.Total 'Total' %></strong></td>
            <td class="align-left" valign="baseline" align="left">&nbsp;</td>
