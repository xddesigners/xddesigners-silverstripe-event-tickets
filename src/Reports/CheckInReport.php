...
namespace XD\EventTickets\Reports;
    ...
    public function parameterFields()
    {
        ...
        $fields = FieldList::create(
            DropdownField::create(
                'TicketPage', 
                _t('XD\EventTickets\Reports.TicketPage', 'All checkins for event'), 
                $ticketPages->map()->toArray()
            )->setEmptyString(_t('XD\EventTickets\Reports.TicketPageEmpty', 'Select event')),
            DropdownField::create(
                'TicketType', 
                _t('XD\EventTickets\Reports.TicketType', 'All checkins for ticket type'), 
            ...
            )->setEmptyString(_t('XD\EventTickets\Reports.AllMessages', 'All messages')),
            DropdownField::create(
                'DefinedPeriod', 
                _t('XD\EventTickets\Reports.DefinedPeriod', 'Period'), 
                [
                    'Day' => _t('XD\EventTickets\Reports.Day', 'Today'),
                    'Week' => _t('XD\EventTickets\Reports.Week', 'This week'),
                    'Month' => _t('XD\EventTickets\Reports.Month', 'This month'),
                    'Year' => _t('XD\EventTickets\Reports.Year', 'This year'),
                    'Other' => _t('XD\EventTickets\Reports.Other', 'Custom period'),
                ]
            )->setEmptyString(_t('XD\EventTickets\Reports.FilterPeriod', 'Filter on period')),
            DateField::create('CustomPeriodFrom',  _t('XD\EventTickets\Reports.CustomPeriodFrom', 'From date')),
            DateField::create('CustomPeriodTill',  _t('XD\EventTickets\Reports.CustomPeriodTill', 'Till date')),
            DropdownField::create(
                'GroupByScanDate', 
                _t('XD\EventTickets\Reports.GroupByScanDate', 'Group by scan date'), 
                [
                    'Minute' => _t('XD\EventTickets\Reports.GroupByMinute', 'Minute'),
                    'Hour' => _t('XD\EventTickets\Reports.GroupByHour', 'Hour'),
                    'Day' => _t('XD\EventTickets\Reports.GroupByDay', 'Day'),
                    'Week' => _t('XD\EventTickets\Reports.GroupByWeek', 'Week'),
                    'Month' => _t('XD\EventTickets\Reports.GroupByMonth', 'Month'),
                    'Year' => _t('XD\EventTickets\Reports.GroupByYear', 'Year'),
                ]
            )->setEmptyString(_t('XD\EventTickets\Reports.GroupByEmpty', 'Don\'t group')),
            CheckboxSetField::create('GroupBy', _t('XD\EventTickets\Reports.GroupByMessage', 'Group by'), [
                'MessageCode' => _t('XD\EventTickets\Reports.GroupByMessage', 'Group by message'),
                'TicketTitle' => _t('XD\EventTickets\Reports.GroupByTicket', 'Group by ticket'),
                'EventTitle' => _t('XD\EventTickets\Reports.GroupByEvent', 'Group by event'),
                'AttendeeName' => _t('XD\EventTickets\Reports.GroupByAttendee', 'Group by attendee'),
            ]),
        );
