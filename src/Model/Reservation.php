...
use XD\EventTickets\Forms\GridField\GridFieldConfig_ReservationViewer;
use Exception;
...
class Reservation extends DataObject
{
    ...
    public function createTicketFile()
    {
        ...
        $html = SSViewer::execute_template('XD\\EventTickets\\ReservationPrintable', $this);
        $pdf = new Mpdf();
        $pdf->WriteHTML($html);
        return $pdf;
    }
    ...
    public function sendReservation()
    {
        ...
        $email->setHTMLTemplate('XD\\EventTickets\\ReservationEmail');
    ...
    public function sendNotification()
    {
        ...
        $email->setFrom($from);
        $email->setTo($to);
        $email->setHTMLTemplate('XD\\EventTickets\\NotificationMail');
        $email->setData($this);
