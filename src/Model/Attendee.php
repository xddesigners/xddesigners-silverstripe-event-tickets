...
namespace XD\EventTickets\Model;

use BaconQrCode\Renderer\ImageRenderer;
use BaconQrCode\Renderer\RendererStyle\RendererStyle;
use BaconQrCode\Writer;
use XD\EventTickets\Extensions\TicketExtension;
use XD\EventTickets\Forms\CheckInValidator;
use XD\EventTickets\Model\UserFields\UserEmailField;
use XD\EventTickets\Model\UserFields\UserField;
use XD\EventTickets\Model\UserFields\UserTextField;
use Exception;
...
class Attendee extends DataObject
{
    ...
    public function sendTicket()
    {
        ...
        $email->setFrom($from);
        $email->setTo($to);
        $email->setHTMLTemplate('XD\\EventTickets\\TicketEmail');
    ...
    public function createTicketFile()
    {
        ...
        $html = SSViewer::execute_template('XD\\EventTickets\\ReservationPrintable', new ArrayData([
